...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    setFloor1Beds([
      ...
      { id: 8, number: 107, isVacant: true },
      { id: 9, number: 107, isVacant: true },
      { id: 10, number: 107, isVacant: true },
      { id: 11, number: 107, isVacant: true },
      { id: 12, number: 107, isVacant: true },
      { id: 13, number: 107, isVacant: true },
      { id: 14, number: 107, isVacant: true },
    ]);
    setFloor2Beds([
